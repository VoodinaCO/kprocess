...
;(function ($, window, document, undefined) {
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setToolbar: function () {
            ...
            var btnNext = this.options.toolbarSettings.showNextButton !== false ? $('<button></button>').text($("<textarea/>").html(this.options.lang.next).text()).addClass('btn btn-secondary sw-btn-next').attr('type', 'button') : null;
            var btnPrevious = this.options.toolbarSettings.showPreviousButton !== false ? $('<button></button>').text($("<textarea/>").html(this.options.lang.previous).text()).addClass('btn btn-secondary sw-btn-prev').attr('type', 'button') : null;
        ...
        _loadStepContent: function (idx) {
            ...
            if (contentURL && contentURL.length > 0 && (!elm.data('has-content') || !this.options.contentCache)) {
                ...
                // Warning !! When we reload the page, the content-url elements is equal to #. To avoid Ajax to load the same page inside the content indefinitely
                // I redirect the current page to the beginning of the wizard.
                if (elm.data('content-url') && elm.data('content-url').length > 0 && elm.data('content-url') === "#") {
                ...
                var ajaxSettings = $.extend(true, {}, {
                    //url: contentURL,
                    url: elm.data('content-url') && elm.data('content-url').length > 0 ? elm.data('content-url') : this.options.contentURL,
                    type: "POST",
