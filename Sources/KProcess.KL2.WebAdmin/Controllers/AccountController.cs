...
namespace KProcess.KL2.WebAdmin.Controllers
{
    ...
    public class AccountController : LocalizedController
    {
        ...
        private readonly ILanguageStorageProvider _languageStorageProvider;
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new KL2IdentityUser { UserName = model.Username};
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new KL2IdentityUser { UserName = model.Email};
