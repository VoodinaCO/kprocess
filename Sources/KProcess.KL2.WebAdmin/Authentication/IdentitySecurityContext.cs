...
namespace KProcess.KL2.WebAdmin.Authentication
{
    ...
    public class IdentitySecurityContext : ISecurityContext
    {
        ...
        private readonly IEnumerable<IAuthenticationMode> _authenticationModes;


        private bool _isInitialized;
        private Dictionary<Type, string[]> _rolesReadAuthorizations;
        private Dictionary<Type, string[]> _rolesWriteAuthorizations;
        private Dictionary<Type, short[]> _featuresReadAuthorizations;
        private Dictionary<Type, short[]> _featuresWriteAuthorizations;

        private Dictionary<Type, Func<string, bool>> _customReadAuthorizations;
        private Dictionary<Type, Func<string, bool>> _customWriteAuthorizations;
        ...
        {
            //Models.User user = await _serviceBus.Get<IAuthenticationService>().GetUser(SecurityConstants.DefaultAdminUsername);
        ...
        /// </summary>
        public Ksmed.Security.Activation.ProductLicense CurrentProductLicense { get; set; }
        ...
        /// </returns>
        public bool HasCurrentLicenseFeature(Ksmed.Security.Activation.ActivationFeatures feature) =>
