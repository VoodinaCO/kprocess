...
namespace KProcess.KL2.Server.SetupUI
{
    public class ManagedBA : BootstrapperApplication, INotifyPropertyChanged
    {
        ...
        protected override void Run()
        {
            ...
            Log("Launching KL² Server bootstrapper UX");
            ...
            DetectPackageComplete += (sender, e) =>
            {
                ...
                if (launchAction == LaunchAction.Install && e.PackageId == "KL2_API_MSI" && e.State == PackageState.Present)
            ...
            DetectRelatedMsiPackage += (sender, e) =>
            {
                ...
                if (launchAction == LaunchAction.Install && e.PackageId == "KL2_API_MSI" && e.Operation == RelatedOperation.MajorUpgrade)
            ...
            ExecutePackageBegin += (o, e) =>
            {
                ...
                {
                    case "KL2_API_MSI":
                        CurrentlyProcessingPackageName = "KL² API";
                        break;
                    case "KL2_FILESERVER_MSI":
                        CurrentlyProcessingPackageName = "KL² Files Server";
                        break;
                    case "KL2_NOTIFICATION_MSI":
                        CurrentlyProcessingPackageName = "KL² Notification Service";
                        break;
                    case "KL2_WEBSERVICES_MSI":
                        CurrentlyProcessingPackageName = "KL² Web Services";
                        break;
                    default:
