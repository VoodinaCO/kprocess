...
namespace KProcess.Ksmed.Models
{
    ...
    /// <summary>
    /// Représente un document associé à une action.
    /// </summary>
    public partial class Ref4 : ReferentialBase, IObjectWithChangeTracker, INotifyPropertyChanged
    {
    
        #region Constantes
    
        public const string TypeFullName = "KProcess.Ksmed.Models.Ref4";
        ...
        /// <summary>
        /// Initialise une nouvelle instance de la classe <see cref="Ref4"/>.
        /// </summary>
    	public Ref4()
    	{
    		this.Initialize();
        ...
        [DataMember]
    	[ScriptIgnore]
        public TrackableCollection<Ref4Action> Ref4Actions
        {
            get
            {
                if (_ref4Actions == null)
                {
                    _ref4Actions = new TrackableCollection<Ref4Action>();
                    _ref4Actions.CollectionChanged += FixupRef4Actions;
                }
                return _ref4Actions;
            }
            set
            {
                if (!ReferenceEquals(_ref4Actions, value))
                {
                    ...
                    if (_ref4Actions != null)
                    {
                        ...
                        foreach (Ref4Action item in _ref4Actions)
                        {
                    ...
                    OnNavigationPropertyChanged("Ref4Actions");
                }
            }
        }
        private TrackableCollection<Ref4Action> _ref4Actions;
        ...
        private void FixupCreator(User previousValue)
        {
            ...
            if (previousValue != null && previousValue.CreatedRefs4.Contains(this))
            {
                previousValue.CreatedRefs4.Remove(this);
            }
    
            if (Creator != null)
            {
                if (!Creator.CreatedRefs4.Contains(this))
                {
                    Creator.CreatedRefs4.Add(this);
                }
        ...
        private void FixupLastModifier(User previousValue)
        {
            ...
            if (previousValue != null && previousValue.LastModifiedRefs4.Contains(this))
            {
                previousValue.LastModifiedRefs4.Remove(this);
            }
    
            if (LastModifier != null)
            {
                if (!LastModifier.LastModifiedRefs4.Contains(this))
                {
                    LastModifier.LastModifiedRefs4.Add(this);
                }
        ...
        private void FixupProcess(Procedure previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.Refs4.Contains(this))
            {
                previousValue.Refs4.Remove(this);
            }
    
            if (Process != null)
            {
                if (!Process.Refs4.Contains(this))
                {
                    Process.Refs4.Add(this);
                }
        ...
        private void FixupCloudFile(CloudFile previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.Ref4.Contains(this))
            {
                previousValue.Ref4.Remove(this);
            }
    
            if (CloudFile != null)
            {
                if (!CloudFile.Ref4.Contains(this))
                {
                    CloudFile.Ref4.Add(this);
                }
        ...
        /// <summary>
        /// Corrige l'état de la propriété Ref4Actions.
        /// </summary>
        private void FixupRef4Actions(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (Ref4Action item in e.NewItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("Ref4Actions", item);
                    }
                    // This is the principal end in an association that performs cascade deletes.
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.Ref4, this))
                    {
                        item.Ref4 = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("Ref4Actions", item);
    	...
    	public virtual void AddItemToCollection(string propertyName, object value)
    	{
    		...
    		{
    			case "Ref4Actions":
    				this.Ref4Actions.Add((Ref4Action)value);
    				break;
    			default:
    				break;
    		}
    	...
    	public virtual void RemoveItemFromCollection(string propertyName, object value)
    	{
    		...
    		{
    			case "Ref4Actions":
    				this.Ref4Actions.Remove((Ref4Action)value);
    				break;
    			default:
    				break;
    		}
    	...
    	public virtual IDictionary<string,object> GetCurrentValues()
    	{
    		...
    		values.Add("Ref4Actions", GetHashCodes(this.Ref4Actions));
    		return values;
    	}	
    	...
    	public virtual IDictionary<string,dynamic> GetGraphValues()
    	{
    		...
    		values.Add("Ref4Actions", this.Ref4Actions);
    		return values;
    	}
