...
namespace KProcess.Ksmed.Models
{
    ...
    /// </summary>
    public partial class Ref6 : ReferentialBase, IObjectWithChangeTracker, INotifyPropertyChanged
    {
    
        #region Constantes
    
        public const string TypeFullName = "KProcess.Ksmed.Models.Ref6";
        ...
        /// <summary>
        /// Initialise une nouvelle instance de la classe <see cref="Ref6"/>.
        /// </summary>
    	public Ref6()
    	{
    		this.Initialize();
        ...
        [DataMember]
    	[ScriptIgnore]
        public TrackableCollection<Ref6Action> Ref6Actions
        {
            get
            {
                if (_ref6Actions == null)
                {
                    _ref6Actions = new TrackableCollection<Ref6Action>();
                    _ref6Actions.CollectionChanged += FixupRef6Actions;
                }
                return _ref6Actions;
            }
            set
            {
                if (!ReferenceEquals(_ref6Actions, value))
                {
                    ...
                    if (_ref6Actions != null)
                    {
                        ...
                        foreach (Ref6Action item in _ref6Actions)
                        {
                    ...
                    OnNavigationPropertyChanged("Ref6Actions");
                }
            }
        }
        private TrackableCollection<Ref6Action> _ref6Actions;
        ...
        private void FixupCreator(User previousValue)
        {
            ...
            if (previousValue != null && previousValue.CreatedRefs6.Contains(this))
            {
                previousValue.CreatedRefs6.Remove(this);
            }
    
            if (Creator != null)
            {
                if (!Creator.CreatedRefs6.Contains(this))
                {
                    Creator.CreatedRefs6.Add(this);
                }
        ...
        private void FixupLastModifier(User previousValue)
        {
            ...
            if (previousValue != null && previousValue.LastModifiedRefs6.Contains(this))
            {
                previousValue.LastModifiedRefs6.Remove(this);
            }
    
            if (LastModifier != null)
            {
                if (!LastModifier.LastModifiedRefs6.Contains(this))
                {
                    LastModifier.LastModifiedRefs6.Add(this);
                }
        ...
        private void FixupProcess(Procedure previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.Refs6.Contains(this))
            {
                previousValue.Refs6.Remove(this);
            }
    
            if (Process != null)
            {
                if (!Process.Refs6.Contains(this))
                {
                    Process.Refs6.Add(this);
                }
        ...
        private void FixupCloudFile(CloudFile previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.Ref6.Contains(this))
            {
                previousValue.Ref6.Remove(this);
            }
    
            if (CloudFile != null)
            {
                if (!CloudFile.Ref6.Contains(this))
                {
                    CloudFile.Ref6.Add(this);
                }
        ...
        /// <summary>
        /// Corrige l'état de la propriété Ref6Actions.
        /// </summary>
        private void FixupRef6Actions(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (Ref6Action item in e.NewItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("Ref6Actions", item);
                    }
                    // This is the principal end in an association that performs cascade deletes.
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.Ref6, this))
                    {
                        item.Ref6 = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("Ref6Actions", item);
    	...
    	public virtual void AddItemToCollection(string propertyName, object value)
    	{
    		...
    		{
    			case "Ref6Actions":
    				this.Ref6Actions.Add((Ref6Action)value);
    				break;
    			default:
    				break;
    		}
    	...
    	public virtual void RemoveItemFromCollection(string propertyName, object value)
    	{
    		...
    		{
    			case "Ref6Actions":
    				this.Ref6Actions.Remove((Ref6Action)value);
    				break;
    			default:
    				break;
    		}
    	...
    	public virtual IDictionary<string,object> GetCurrentValues()
    	{
    		...
    		values.Add("Ref6Actions", GetHashCodes(this.Ref6Actions));
    		return values;
    	}	
    	...
    	public virtual IDictionary<string,dynamic> GetGraphValues()
    	{
    		...
    		values.Add("Ref6Actions", this.Ref6Actions);
    		return values;
    	}
