...
namespace KProcess.Ksmed.Models
{
    ...
    /// <summary>
    /// Représente la liaison entre un référentiel additionel 2 et une action.
    /// </summary>
    public partial class Ref6Action : ModelBase, IObjectWithChangeTracker, INotifyPropertyChanged
    {
    
        #region Constantes
    
        public const string TypeFullName = "KProcess.Ksmed.Models.Ref6Action";
        ...
        /// <summary>
        /// Initialise une nouvelle instance de la classe <see cref="Ref6Action"/>.
        /// </summary>
    	public Ref6Action()
    	{
    		this.Initialize();
        ...
        public Ref6 Ref6
        {
            ...
            set
            {
                if (!ReferenceEquals(_ref6, value))
                {
                    ...
                    var previousValue = _ref6;
                    _ref6 = value;
                    FixupRef6(previousValue);
        ...
        private void FixupAction(KAction previousValue)
        {
            ...
            if (Action != null)
            {
                if (!Action.Ref6.Contains(this))
                {
                    Action.Ref6.Add(this);
                }
        ...
        /// <summary>
        /// Corrige l'état de la propriété de navigation Ref6.
        /// </summary>
        private void FixupRef6(Ref6 previousValue)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (previousValue != null && previousValue.Ref6Actions.Contains(this))
            {
                previousValue.Ref6Actions.Remove(this);
            }
    
            if (Ref6 != null)
            {
                if (!Ref6.Ref6Actions.Contains(this))
                {
                    Ref6.Ref6Actions.Add(this);
                }
            ...
            if (ChangeTracker.ChangeTrackingEnabled)
            {
                ChangeTracker.RecordValue("Ref6", previousValue, Ref6);
                if (Ref6 != null && !Ref6.ChangeTracker.ChangeTrackingEnabled)
                {
                    Ref6.StartTracking();
                }
            }
