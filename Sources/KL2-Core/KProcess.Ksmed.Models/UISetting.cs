...
namespace KProcess.Ksmed.Models
{
    ...
    /// <summary>
    /// Représente un paramètre IHM de l'application.
    /// </summary>
    public partial class UISetting : ModelBase, IObjectWithChangeTracker, INotifyPropertyChanged
    {
    
        #region Constantes
    
        public const string TypeFullName = "KProcess.Ksmed.Models.UISetting";
        ...
        /// <summary>
        /// Initialise une nouvelle instance de la classe <see cref="UISetting"/>.
        /// </summary>
    	public UISetting()
    	{
    		this.Initialize();
        ...
        private string _key;
        /// <summary>
        /// Obtient ou définit la clé du paramètre.
        /// </summary>
        [DataMember]
        public string Key
        {
