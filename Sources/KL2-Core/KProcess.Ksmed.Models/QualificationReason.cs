...
namespace KProcess.Ksmed.Models
{
    ...
    /// 
    /// </summary>
    public partial class QualificationReason : ModelBase, IObjectWithChangeTracker, INotifyPropertyChanged
    {
    
        #region Constantes
    
        public const string TypeFullName = "KProcess.Ksmed.Models.QualificationReason";
        ...
        /// <summary>
        /// Initialise une nouvelle instance de la classe <see cref="QualificationReason"/>.
        /// </summary>
    	public QualificationReason()
    	{
    		this.Initialize();
    	}
        ...
        public int Number
        {
            ...
            set
            {
                if (_number != value)
                {
                    ChangeTracker.RecordValue("Number", _number, value);
                    _number = value;
        ...
        public bool IsEditable
        {
            ...
            set
            {
                ...
                {
                    ChangeTracker.RecordValue("IsEditable", _isEditable, value);
                    _isEditable = value;
                    OnEntityPropertyChanged("IsEditable");
                }
            }
        }
        ...
        private void FixupQualificationSteps(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.QualificationReason, this))
                    {
    	...
    	public virtual IDictionary<string,object> GetCurrentValues()
    	{
    		...
    		values.Add("IsEditable", this.IsEditable);
