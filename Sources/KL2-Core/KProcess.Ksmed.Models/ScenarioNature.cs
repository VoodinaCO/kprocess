...
namespace KProcess.Ksmed.Models
{
    ...
    /// <summary>
    /// Représente la nature d'un scénario.
    /// </summary>
    public partial class ScenarioNature : ModelBase, IObjectWithChangeTracker, INotifyPropertyChanged, ILocalizedLabels
    {
    
        #region Constantes
    
        public const string TypeFullName = "KProcess.Ksmed.Models.ScenarioNature";
        ...
        /// <summary>
        /// Initialise une nouvelle instance de la classe <see cref="ScenarioNature"/>.
        /// </summary>
    	public ScenarioNature()
    	{
    		this.Initialize();
    	}
        ...
        private string _scenarioNatureCode;
        /// <summary>
        /// Obtient ou définit l'identifiant de la nature.
        /// </summary>
        [DataMember]
        public string ScenarioNatureCode
        {
            get { return _scenarioNatureCode; }
            set
            {
                if (_scenarioNatureCode != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'ScenarioNatureCode' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _scenarioNatureCode = value;
                    OnEntityPropertyChanged("ScenarioNatureCode");
                }
            }
        }
        ...
        private void FixupLongLabelResource(AppResourceKey previousValue)
        {
            ...
            if (previousValue != null && previousValue.ScenarioNaturesForLongLabel.Contains(this))
            {
                previousValue.ScenarioNaturesForLongLabel.Remove(this);
            }
    
            if (LongLabelResource != null)
            {
                if (!LongLabelResource.ScenarioNaturesForLongLabel.Contains(this))
                {
                    LongLabelResource.ScenarioNaturesForLongLabel.Add(this);
                }
        ...
        private void FixupShortLabelResource(AppResourceKey previousValue)
        {
            ...
            if (previousValue != null && previousValue.ScenarioNaturesForShortLabel.Contains(this))
            {
                previousValue.ScenarioNaturesForShortLabel.Remove(this);
            }
    
            if (ShortLabelResource != null)
            {
                if (!ShortLabelResource.ScenarioNaturesForShortLabel.Contains(this))
                {
                    ShortLabelResource.ScenarioNaturesForShortLabel.Add(this);
                }
        ...
        private void FixupScenarios(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.Nature, this))
                    {
                        item.Nature = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
    	...
    	public virtual void SetPropertyValue(string propertyName, object value)
    	{
    		switch (propertyName)
    		{
    			case "ScenarioNatureCode":
    				this.ScenarioNatureCode = (string)value;
    				break;
    	...
    	public virtual IDictionary<string,object> GetCurrentValues()
    	{
    		...
    		values.Add("ScenarioNatureCode", this.ScenarioNatureCode);
