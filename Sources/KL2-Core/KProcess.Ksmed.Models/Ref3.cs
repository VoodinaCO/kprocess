...
namespace KProcess.Ksmed.Models
{
    ...
    /// <summary>
    /// Représente un lieu dans un projet.
    /// </summary>
    public partial class Ref3 : ReferentialBase, IObjectWithChangeTracker, INotifyPropertyChanged
    {
    
        #region Constantes
    
        public const string TypeFullName = "KProcess.Ksmed.Models.Ref3";
        ...
        /// <summary>
        /// Initialise une nouvelle instance de la classe <see cref="Ref3"/>.
        /// </summary>
    	public Ref3()
    	{
    		this.Initialize();
        ...
        [DataMember]
    	[ScriptIgnore]
        public TrackableCollection<Ref3Action> Ref3Actions
        {
            get
            {
                if (_ref3Actions == null)
                {
                    _ref3Actions = new TrackableCollection<Ref3Action>();
                    _ref3Actions.CollectionChanged += FixupRef3Actions;
                }
                return _ref3Actions;
            }
            set
            {
                if (!ReferenceEquals(_ref3Actions, value))
                {
                    ...
                    if (_ref3Actions != null)
                    {
                        ...
                        foreach (Ref3Action item in _ref3Actions)
                        {
                    ...
                    OnNavigationPropertyChanged("Ref3Actions");
                }
            }
        }
        private TrackableCollection<Ref3Action> _ref3Actions;
        ...
        private void FixupCreator(User previousValue)
        {
            ...
            if (previousValue != null && previousValue.CreatedRefs3.Contains(this))
            {
                previousValue.CreatedRefs3.Remove(this);
            }
    
            if (Creator != null)
            {
                if (!Creator.CreatedRefs3.Contains(this))
                {
                    Creator.CreatedRefs3.Add(this);
                }
        ...
        private void FixupLastModifier(User previousValue)
        {
            ...
            if (previousValue != null && previousValue.LastModifiedRefs3.Contains(this))
            {
                previousValue.LastModifiedRefs3.Remove(this);
            }
    
            if (LastModifier != null)
            {
                if (!LastModifier.LastModifiedRefs3.Contains(this))
                {
                    LastModifier.LastModifiedRefs3.Add(this);
                }
        ...
        private void FixupProcess(Procedure previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.Refs3.Contains(this))
            {
                previousValue.Refs3.Remove(this);
            }
    
            if (Process != null)
            {
                if (!Process.Refs3.Contains(this))
                {
                    Process.Refs3.Add(this);
                }
        ...
        private void FixupCloudFile(CloudFile previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.Ref3.Contains(this))
            {
                previousValue.Ref3.Remove(this);
            }
    
            if (CloudFile != null)
            {
                if (!CloudFile.Ref3.Contains(this))
                {
                    CloudFile.Ref3.Add(this);
                }
        ...
        /// <summary>
        /// Corrige l'état de la propriété Ref3Actions.
        /// </summary>
        private void FixupRef3Actions(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (Ref3Action item in e.NewItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("Ref3Actions", item);
                    }
                    // This is the principal end in an association that performs cascade deletes.
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.Ref3, this))
                    {
                        item.Ref3 = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("Ref3Actions", item);
    	...
    	public virtual void AddItemToCollection(string propertyName, object value)
    	{
    		...
    		{
    			case "Ref3Actions":
    				this.Ref3Actions.Add((Ref3Action)value);
    				break;
    			default:
    				break;
    		}
    	...
    	public virtual void RemoveItemFromCollection(string propertyName, object value)
    	{
    		...
    		{
    			case "Ref3Actions":
    				this.Ref3Actions.Remove((Ref3Action)value);
    				break;
    			default:
    				break;
    		}
    	...
    	public virtual IDictionary<string,object> GetCurrentValues()
    	{
    		...
    		values.Add("Ref3Actions", GetHashCodes(this.Ref3Actions));
    		return values;
    	}	
    	...
    	public virtual IDictionary<string,dynamic> GetGraphValues()
    	{
    		...
    		values.Add("Ref3Actions", this.Ref3Actions);
    		return values;
    	}
