...
namespace KProcess.Ksmed.Models
{
    ...
    /// <summary>
    /// Représente le référentiel additionel 3.
    /// </summary>
    public partial class Ref7 : ReferentialBase, IObjectWithChangeTracker, INotifyPropertyChanged
    {
    
        #region Constantes
    
        public const string TypeFullName = "KProcess.Ksmed.Models.Ref7";
        ...
        /// <summary>
        /// Initialise une nouvelle instance de la classe <see cref="Ref7"/>.
        /// </summary>
    	public Ref7()
    	{
    		this.Initialize();
        ...
        [DataMember]
    	[ScriptIgnore]
        public TrackableCollection<Ref7Action> Ref7Actions
        {
            get
            {
                if (_ref7Actions == null)
                {
                    _ref7Actions = new TrackableCollection<Ref7Action>();
                    _ref7Actions.CollectionChanged += FixupRef7Actions;
                }
                return _ref7Actions;
            }
            set
            {
                if (!ReferenceEquals(_ref7Actions, value))
                {
                    ...
                    if (_ref7Actions != null)
                    {
                        ...
                        foreach (Ref7Action item in _ref7Actions)
                        {
                    ...
                    OnNavigationPropertyChanged("Ref7Actions");
                }
            }
        }
        private TrackableCollection<Ref7Action> _ref7Actions;
        ...
        private void FixupCreator(User previousValue)
        {
            ...
            if (previousValue != null && previousValue.CreatedRefs7.Contains(this))
            {
                previousValue.CreatedRefs7.Remove(this);
            }
    
            if (Creator != null)
            {
                if (!Creator.CreatedRefs7.Contains(this))
                {
                    Creator.CreatedRefs7.Add(this);
                }
        ...
        private void FixupLastModifier(User previousValue)
        {
            ...
            if (previousValue != null && previousValue.LastModifiedRefs7.Contains(this))
            {
                previousValue.LastModifiedRefs7.Remove(this);
            }
    
            if (LastModifier != null)
            {
                if (!LastModifier.LastModifiedRefs7.Contains(this))
                {
                    LastModifier.LastModifiedRefs7.Add(this);
                }
        ...
        private void FixupProcess(Procedure previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.Refs7.Contains(this))
            {
                previousValue.Refs7.Remove(this);
            }
    
            if (Process != null)
            {
                if (!Process.Refs7.Contains(this))
                {
                    Process.Refs7.Add(this);
                }
        ...
        private void FixupCloudFile(CloudFile previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.Ref7.Contains(this))
            {
                previousValue.Ref7.Remove(this);
            }
    
            if (CloudFile != null)
            {
                if (!CloudFile.Ref7.Contains(this))
                {
                    CloudFile.Ref7.Add(this);
                }
        ...
        /// <summary>
        /// Corrige l'état de la propriété Ref7Actions.
        /// </summary>
        private void FixupRef7Actions(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (Ref7Action item in e.NewItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("Ref7Actions", item);
                    }
                    // This is the principal end in an association that performs cascade deletes.
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.Ref7, this))
                    {
                        item.Ref7 = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("Ref7Actions", item);
    	...
    	public virtual void AddItemToCollection(string propertyName, object value)
    	{
    		...
    		{
    			case "Ref7Actions":
    				this.Ref7Actions.Add((Ref7Action)value);
    				break;
    			default:
    				break;
    		}
    	...
    	public virtual void RemoveItemFromCollection(string propertyName, object value)
    	{
    		...
    		{
    			case "Ref7Actions":
    				this.Ref7Actions.Remove((Ref7Action)value);
    				break;
    			default:
    				break;
    		}
    	...
    	public virtual IDictionary<string,object> GetCurrentValues()
    	{
    		...
    		values.Add("Ref7Actions", GetHashCodes(this.Ref7Actions));
    		return values;
    	}	
    	...
    	public virtual IDictionary<string,dynamic> GetGraphValues()
    	{
    		...
    		values.Add("Ref7Actions", this.Ref7Actions);
    		return values;
    	}
