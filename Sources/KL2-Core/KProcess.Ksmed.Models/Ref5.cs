...
namespace KProcess.Ksmed.Models
{
    ...
    /// </summary>
    public partial class Ref5 : ReferentialBase, IObjectWithChangeTracker, INotifyPropertyChanged
    {
    
        #region Constantes
    
        public const string TypeFullName = "KProcess.Ksmed.Models.Ref5";
        ...
        /// <summary>
        /// Initialise une nouvelle instance de la classe <see cref="Ref5"/>.
        /// </summary>
    	public Ref5()
    	{
    		this.Initialize();
        ...
        [DataMember]
    	[ScriptIgnore]
        public TrackableCollection<Ref5Action> Ref5Actions
        {
            get
            {
                if (_ref5Actions == null)
                {
                    _ref5Actions = new TrackableCollection<Ref5Action>();
                    _ref5Actions.CollectionChanged += FixupRef5Actions;
                }
                return _ref5Actions;
            }
            set
            {
                if (!ReferenceEquals(_ref5Actions, value))
                {
                    ...
                    if (_ref5Actions != null)
                    {
                        ...
                        foreach (Ref5Action item in _ref5Actions)
                        {
                    ...
                    OnNavigationPropertyChanged("Ref5Actions");
                }
            }
        }
        private TrackableCollection<Ref5Action> _ref5Actions;
        ...
        private void FixupCreator(User previousValue)
        {
            ...
            if (previousValue != null && previousValue.CreatedRefs5.Contains(this))
            {
                previousValue.CreatedRefs5.Remove(this);
            }
    
            if (Creator != null)
            {
                if (!Creator.CreatedRefs5.Contains(this))
                {
                    Creator.CreatedRefs5.Add(this);
                }
        ...
        private void FixupLastModifier(User previousValue)
        {
            ...
            if (previousValue != null && previousValue.LastModifiedRefs5.Contains(this))
            {
                previousValue.LastModifiedRefs5.Remove(this);
            }
    
            if (LastModifier != null)
            {
                if (!LastModifier.LastModifiedRefs5.Contains(this))
                {
                    LastModifier.LastModifiedRefs5.Add(this);
                }
        ...
        private void FixupProcess(Procedure previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.Refs5.Contains(this))
            {
                previousValue.Refs5.Remove(this);
            }
    
            if (Process != null)
            {
                if (!Process.Refs5.Contains(this))
                {
                    Process.Refs5.Add(this);
                }
        ...
        private void FixupCloudFile(CloudFile previousValue, bool skipKeys = false)
        {
            ...
            if (CloudFile != null)
            {
                if (!CloudFile.Ref5.Contains(this))
                {
                    CloudFile.Ref5.Add(this);
                }
        ...
        /// <summary>
        /// Corrige l'état de la propriété Ref5Actions.
        /// </summary>
        private void FixupRef5Actions(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (Ref5Action item in e.NewItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("Ref5Actions", item);
                    }
                    // This is the principal end in an association that performs cascade deletes.
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.Ref5, this))
                    {
                        item.Ref5 = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("Ref5Actions", item);
    	...
    	public virtual void AddItemToCollection(string propertyName, object value)
    	{
    		...
    		{
    			case "Ref5Actions":
    				this.Ref5Actions.Add((Ref5Action)value);
    				break;
    			default:
    				break;
    		}
    	...
    	public virtual void RemoveItemFromCollection(string propertyName, object value)
    	{
    		...
    		{
    			case "Ref5Actions":
    				this.Ref5Actions.Remove((Ref5Action)value);
    				break;
    			default:
    				break;
    		}
    	...
    	public virtual IDictionary<string,object> GetCurrentValues()
    	{
    		...
    		values.Add("Ref5Actions", GetHashCodes(this.Ref5Actions));
    		return values;
    	}	
    	...
    	public virtual IDictionary<string,dynamic> GetGraphValues()
    	{
    		...
    		values.Add("Ref5Actions", this.Ref5Actions);
    		return values;
    	}
