...
namespace KProcess.Ksmed.Models
{
    ...
    /// 
    /// </summary>
    public partial class DocumentationReferential : ModelBase, IObjectWithChangeTracker, INotifyPropertyChanged
    {
    
        #region Constantes
    
        public const string TypeFullName = "KProcess.Ksmed.Models.DocumentationReferential";
        ...
        /// <summary>
        /// Initialise une nouvelle instance de la classe <see cref="DocumentationReferential"/>.
        /// </summary>
    	public DocumentationReferential()
    	{
    		this.Initialize();
    	}
        ...
        private void FixupProcess(Procedure previousValue)
        {
            ...
            if (previousValue != null && previousValue.DocumentationReferentials.Contains(this))
            {
                previousValue.DocumentationReferentials.Remove(this);
            }
    
            if (Process != null)
            {
                if (!Process.DocumentationReferentials.Contains(this))
                {
                    Process.DocumentationReferentials.Add(this);
                }
