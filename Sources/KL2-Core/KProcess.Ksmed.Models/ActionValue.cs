...
namespace KProcess.Ksmed.Models
{
    ...
    /// <summary>
    /// Représente la valorisation d'une action (tâche).
    /// </summary>
    public partial class ActionValue : ModelBase, IObjectWithChangeTracker, INotifyPropertyChanged, ILocalizedLabels
    {
    
        #region Constantes
    
        public const string TypeFullName = "KProcess.Ksmed.Models.ActionValue";
        ...
        /// <summary>
        /// Initialise une nouvelle instance de la classe <see cref="ActionValue"/>.
        /// </summary>
    	public ActionValue()
    	{
    		this.Initialize();
        ...
        /// <summary>
        /// Obtient ou définit le code de cette valorisation d'action.
        /// </summary>
        [DataMember]
        public string ActionValueCode
        {
            ...
            set
            {
                if (_actionValueCode != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'ActionValueCode' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private void FixupLongLabelResource(AppResourceKey previousValue)
        {
            ...
            if (previousValue != null && previousValue.ActionValuesForLongLabel.Contains(this))
            {
                previousValue.ActionValuesForLongLabel.Remove(this);
            }
    
            if (LongLabelResource != null)
            {
                if (!LongLabelResource.ActionValuesForLongLabel.Contains(this))
                {
                    LongLabelResource.ActionValuesForLongLabel.Add(this);
                }
        ...
        private void FixupShortLabelResource(AppResourceKey previousValue)
        {
            ...
            if (previousValue != null && previousValue.ActionValuesForShortLabel.Contains(this))
            {
                previousValue.ActionValuesForShortLabel.Remove(this);
            }
    
            if (ShortLabelResource != null)
            {
                if (!ShortLabelResource.ActionValuesForShortLabel.Contains(this))
                {
                    ShortLabelResource.ActionValuesForShortLabel.Add(this);
                }
        ...
        private void FixupActionCategories(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.Value, this))
                    {
                        item.Value = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
        ...
        private void FixupPublishedActionCategory(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.ActionValue, this))
                    {
