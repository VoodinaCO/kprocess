...
namespace KProcess.Ksmed.Models
{
    ...
    /// <summary>
    /// Représente la liaison entre une référentiel 2 et une action.
    /// </summary>
    public partial class Ref2Action : ModelBase, IObjectWithChangeTracker, INotifyPropertyChanged
    {
    
        #region Constantes
    
        public const string TypeFullName = "KProcess.Ksmed.Models.Ref2Action";
        ...
        /// <summary>
        /// Initialise une nouvelle instance de la classe <see cref="Ref2Action"/>.
        /// </summary>
    	public Ref2Action()
    	{
    		this.Initialize();
        ...
        /// <summary>
        /// Obtient ou définit le consommable associé.
        /// </summary>
        [DataMember]
        public Ref2 Ref2
        {
            ...
            set
            {
                if (!ReferenceEquals(_ref2, value))
                {
                    ...
                    var previousValue = _ref2;
                    _ref2 = value;
                    FixupRef2(previousValue);
        ...
        private void FixupAction(KAction previousValue)
        {
            ...
            if (Action != null)
            {
                if (!Action.Ref2.Contains(this))
                {
                    Action.Ref2.Add(this);
                }
        ...
        /// <summary>
        /// Corrige l'état de la propriété de navigation Ref2.
        /// </summary>
        private void FixupRef2(Ref2 previousValue)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (previousValue != null && previousValue.Ref2Actions.Contains(this))
            {
                previousValue.Ref2Actions.Remove(this);
            }
    
            if (Ref2 != null)
            {
                if (!Ref2.Ref2Actions.Contains(this))
                {
                    Ref2.Ref2Actions.Add(this);
                }
            ...
            if (ChangeTracker.ChangeTrackingEnabled)
            {
                ChangeTracker.RecordValue("Ref2", previousValue, Ref2);
                if (Ref2 != null && !Ref2.ChangeTracker.ChangeTrackingEnabled)
                {
                    Ref2.StartTracking();
                }
            }
