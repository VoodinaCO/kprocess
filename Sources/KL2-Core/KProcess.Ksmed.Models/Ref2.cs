...
namespace KProcess.Ksmed.Models
{
    ...
    /// <summary>
    /// Représente un référentiel 2.
    /// </summary>
    public partial class Ref2 : ReferentialBase, IObjectWithChangeTracker, INotifyPropertyChanged
    {
    
        #region Constantes
    
        public const string TypeFullName = "KProcess.Ksmed.Models.Ref2";
        ...
        /// <summary>
        /// Initialise une nouvelle instance de la classe <see cref="Ref2"/>.
        /// </summary>
    	public Ref2()
    	{
    		this.Initialize();
        ...
        [DataMember]
    	[ScriptIgnore]
        public TrackableCollection<Ref2Action> Ref2Actions
        {
            get
            {
                if (_ref2Actions == null)
                {
                    _ref2Actions = new TrackableCollection<Ref2Action>();
                    _ref2Actions.CollectionChanged += FixupRef2Actions;
                }
                return _ref2Actions;
            }
            set
            {
                if (!ReferenceEquals(_ref2Actions, value))
                {
                    ...
                    if (_ref2Actions != null)
                    {
                        ...
                        foreach (Ref2Action item in _ref2Actions)
                        {
                    ...
                    OnNavigationPropertyChanged("Ref2Actions");
                }
            }
        }
        private TrackableCollection<Ref2Action> _ref2Actions;
        ...
        private void FixupCreator(User previousValue)
        {
            ...
            if (previousValue != null && previousValue.CreatedRefs2.Contains(this))
            {
                previousValue.CreatedRefs2.Remove(this);
            }
    
            if (Creator != null)
            {
                if (!Creator.CreatedRefs2.Contains(this))
                {
                    Creator.CreatedRefs2.Add(this);
                }
        ...
        private void FixupLastModifier(User previousValue)
        {
            ...
            if (previousValue != null && previousValue.LastModifiedRefs2.Contains(this))
            {
                previousValue.LastModifiedRefs2.Remove(this);
            }
    
            if (LastModifier != null)
            {
                if (!LastModifier.LastModifiedRefs2.Contains(this))
                {
                    LastModifier.LastModifiedRefs2.Add(this);
                }
        ...
        private void FixupProcess(Procedure previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.Refs2.Contains(this))
            {
                previousValue.Refs2.Remove(this);
            }
    
            if (Process != null)
            {
                if (!Process.Refs2.Contains(this))
                {
                    Process.Refs2.Add(this);
                }
        ...
        private void FixupCloudFile(CloudFile previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.Ref2.Contains(this))
            {
                previousValue.Ref2.Remove(this);
            }
    
            if (CloudFile != null)
            {
                if (!CloudFile.Ref2.Contains(this))
                {
                    CloudFile.Ref2.Add(this);
                }
        ...
        /// <summary>
        /// Corrige l'état de la propriété Ref2Actions.
        /// </summary>
        private void FixupRef2Actions(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (Ref2Action item in e.NewItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("Ref2Actions", item);
                    }
                    // This is the principal end in an association that performs cascade deletes.
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.Ref2, this))
                    {
                        item.Ref2 = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("Ref2Actions", item);
    	...
    	public virtual void AddItemToCollection(string propertyName, object value)
    	{
    		...
    		{
    			case "Ref2Actions":
    				this.Ref2Actions.Add((Ref2Action)value);
    				break;
    			default:
    				break;
    		}
    	...
    	public virtual void RemoveItemFromCollection(string propertyName, object value)
    	{
    		...
    		{
    			case "Ref2Actions":
    				this.Ref2Actions.Remove((Ref2Action)value);
    				break;
    			default:
    				break;
    		}
    	...
    	public virtual IDictionary<string,object> GetCurrentValues()
    	{
    		...
    		values.Add("Ref2Actions", GetHashCodes(this.Ref2Actions));
    		return values;
    	}	
    	...
    	public virtual IDictionary<string,dynamic> GetGraphValues()
    	{
    		...
    		values.Add("Ref2Actions", this.Ref2Actions);
    		return values;
    	}
