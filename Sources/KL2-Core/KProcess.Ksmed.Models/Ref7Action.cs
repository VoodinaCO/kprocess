...
namespace KProcess.Ksmed.Models
{
    ...
    /// <summary>
    /// Représente la liaison entre un référentiel additionel 3 et une action.
    /// </summary>
    public partial class Ref7Action : ModelBase, IObjectWithChangeTracker, INotifyPropertyChanged
    {
    
        #region Constantes
    
        public const string TypeFullName = "KProcess.Ksmed.Models.Ref7Action";
        ...
        /// <summary>
        /// Initialise une nouvelle instance de la classe <see cref="Ref7Action"/>.
        /// </summary>
    	public Ref7Action()
    	{
    		this.Initialize();
        ...
        public Ref7 Ref7
        {
            ...
            set
            {
                if (!ReferenceEquals(_ref7, value))
                {
                    ...
                    var previousValue = _ref7;
                    _ref7 = value;
                    FixupRef7(previousValue);
        ...
        private void FixupAction(KAction previousValue)
        {
            ...
            if (Action != null)
            {
                if (!Action.Ref7.Contains(this))
                {
                    Action.Ref7.Add(this);
                }
        ...
        /// <summary>
        /// Corrige l'état de la propriété de navigation Ref7.
        /// </summary>
        private void FixupRef7(Ref7 previousValue)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (previousValue != null && previousValue.Ref7Actions.Contains(this))
            {
                previousValue.Ref7Actions.Remove(this);
            }
    
            if (Ref7 != null)
            {
                if (!Ref7.Ref7Actions.Contains(this))
                {
                    Ref7.Ref7Actions.Add(this);
                }
            ...
            if (ChangeTracker.ChangeTrackingEnabled)
            {
                ChangeTracker.RecordValue("Ref7", previousValue, Ref7);
                if (Ref7 != null && !Ref7.ChangeTracker.ChangeTrackingEnabled)
                {
                    Ref7.StartTracking();
                }
            }
