...
namespace KProcess.Ksmed.Models
{
    ...
    /// <summary>
    /// Représente la liaison entre un outil et une action.
    /// </summary>
    public partial class Ref1Action : ModelBase, IObjectWithChangeTracker, INotifyPropertyChanged
    {
    
        #region Constantes
    
        public const string TypeFullName = "KProcess.Ksmed.Models.Ref1Action";
        ...
        /// <summary>
        /// Initialise une nouvelle instance de la classe <see cref="Ref1Action"/>.
        /// </summary>
    	public Ref1Action()
    	{
    		this.Initialize();
        ...
        /// <summary>
        /// Obtient ou définit l'outil associé.
        /// </summary>
        [DataMember]
        public Ref1 Ref1
        {
            ...
            set
            {
                if (!ReferenceEquals(_ref1, value))
                {
                    ...
                    var previousValue = _ref1;
                    _ref1 = value;
                    FixupRef1(previousValue);
        ...
        private void FixupAction(KAction previousValue)
        {
            ...
            if (Action != null)
            {
                if (!Action.Ref1.Contains(this))
                {
                    Action.Ref1.Add(this);
                }
        ...
        /// <summary>
        /// Corrige l'état de la propriété de navigation Ref1.
        /// </summary>
        private void FixupRef1(Ref1 previousValue)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (previousValue != null && previousValue.Ref1Actions.Contains(this))
            {
                previousValue.Ref1Actions.Remove(this);
            }
    
            if (Ref1 != null)
            {
                if (!Ref1.Ref1Actions.Contains(this))
                {
                    Ref1.Ref1Actions.Add(this);
                }
            ...
            if (ChangeTracker.ChangeTrackingEnabled)
            {
                ChangeTracker.RecordValue("Ref1", previousValue, Ref1);
                if (Ref1 != null && !Ref1.ChangeTracker.ChangeTrackingEnabled)
                {
                    Ref1.StartTracking();
                }
            }
