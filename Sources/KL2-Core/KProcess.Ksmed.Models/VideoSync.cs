...
namespace KProcess.Ksmed.Models
{
    ...
    /// 
    /// </summary>
    public partial class VideoSync : ModelBase, IObjectWithChangeTracker, INotifyPropertyChanged
    {
    
        #region Constantes
    
        public const string TypeFullName = "KProcess.Ksmed.Models.VideoSync";
        ...
        /// <summary>
        /// Initialise une nouvelle instance de la classe <see cref="VideoSync"/>.
        /// </summary>
    	public VideoSync()
    	{
    		this.Initialize();
        ...
        public bool SyncValue
        {
            ...
            set
            {
                if (_syncValue != value)
                {
                    ChangeTracker.RecordValue("SyncValue", _syncValue, value);
                    _syncValue = value;
                    OnEntityPropertyChanged("SyncValue");
                }
            }
        }
        ...
        private void FixupUser(User previousValue)
        {
            ...
            if (previousValue != null && previousValue.VideoSyncs.Contains(this))
            {
                previousValue.VideoSyncs.Remove(this);
            }
    
            if (User != null)
            {
                if (!User.VideoSyncs.Contains(this))
                {
                    User.VideoSyncs.Add(this);
                }
        ...
        private void FixupProcess(Procedure previousValue)
        {
            ...
            if (Process != null)
            {
                if (!Process.VideoSyncs.Contains(this))
                {
                    Process.VideoSyncs.Add(this);
                }
    	...
    	public virtual IDictionary<string,object> GetCurrentValues()
    	{
    		...
    		values.Add("SyncValue", this.SyncValue);
