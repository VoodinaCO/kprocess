...
namespace KProcess.Ksmed.Models
{
    ...
    /// <summary>
    /// Représente la liaison entre un lieu et une action.
    /// </summary>
    public partial class Ref3Action : ModelBase, IObjectWithChangeTracker, INotifyPropertyChanged
    {
    
        #region Constantes
    
        public const string TypeFullName = "KProcess.Ksmed.Models.Ref3Action";
        ...
        /// <summary>
        /// Initialise une nouvelle instance de la classe <see cref="Ref3Action"/>.
        /// </summary>
    	public Ref3Action()
    	{
    		this.Initialize();
        ...
        /// <summary>
        /// Obtient ou définit le lieu associé.
        /// </summary>
        [DataMember]
        public Ref3 Ref3
        {
            ...
            set
            {
                if (!ReferenceEquals(_ref3, value))
                {
                    ...
                    var previousValue = _ref3;
                    _ref3 = value;
                    FixupRef3(previousValue);
        ...
        private void FixupAction(KAction previousValue)
        {
            ...
            if (Action != null)
            {
                if (!Action.Ref3.Contains(this))
                {
                    Action.Ref3.Add(this);
                }
        ...
        /// <summary>
        /// Corrige l'état de la propriété de navigation Ref3.
        /// </summary>
        private void FixupRef3(Ref3 previousValue)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (previousValue != null && previousValue.Ref3Actions.Contains(this))
            {
                previousValue.Ref3Actions.Remove(this);
            }
    
            if (Ref3 != null)
            {
                if (!Ref3.Ref3Actions.Contains(this))
                {
                    Ref3.Ref3Actions.Add(this);
                }
            ...
            if (ChangeTracker.ChangeTrackingEnabled)
            {
                ChangeTracker.RecordValue("Ref3", previousValue, Ref3);
                if (Ref3 != null && !Ref3.ChangeTracker.ChangeTrackingEnabled)
                {
                    Ref3.StartTracking();
                }
            }
