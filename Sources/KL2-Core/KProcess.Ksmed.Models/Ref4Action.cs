...
namespace KProcess.Ksmed.Models
{
    ...
    /// <summary>
    /// Représente la liaison entre un document et une action.
    /// </summary>
    public partial class Ref4Action : ModelBase, IObjectWithChangeTracker, INotifyPropertyChanged
    {
    
        #region Constantes
    
        public const string TypeFullName = "KProcess.Ksmed.Models.Ref4Action";
        ...
        /// <summary>
        /// Initialise une nouvelle instance de la classe <see cref="Ref4Action"/>.
        /// </summary>
    	public Ref4Action()
    	{
    		this.Initialize();
        ...
        /// <summary>
        /// Obtient ou définit le document associé.
        /// </summary>
        [DataMember]
        public Ref4 Ref4
        {
            ...
            set
            {
                if (!ReferenceEquals(_ref4, value))
                {
                    ...
                    var previousValue = _ref4;
                    _ref4 = value;
                    FixupRef4(previousValue);
        ...
        private void FixupAction(KAction previousValue)
        {
            ...
            if (Action != null)
            {
                if (!Action.Ref4.Contains(this))
                {
                    Action.Ref4.Add(this);
                }
        ...
        /// <summary>
        /// Corrige l'état de la propriété de navigation Ref4.
        /// </summary>
        private void FixupRef4(Ref4 previousValue)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (previousValue != null && previousValue.Ref4Actions.Contains(this))
            {
                previousValue.Ref4Actions.Remove(this);
            }
    
            if (Ref4 != null)
            {
                if (!Ref4.Ref4Actions.Contains(this))
                {
                    Ref4.Ref4Actions.Add(this);
                }
            ...
            if (ChangeTracker.ChangeTrackingEnabled)
            {
                ChangeTracker.RecordValue("Ref4", previousValue, Ref4);
                if (Ref4 != null && !Ref4.ChangeTracker.ChangeTrackingEnabled)
                {
                    Ref4.StartTracking();
                }
            }
