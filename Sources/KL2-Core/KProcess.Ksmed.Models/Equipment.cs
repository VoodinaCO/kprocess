...
namespace KProcess.Ksmed.Models
{
    ...
    /// <summary>
    /// Représente un équipement d'un projet.
    /// </summary>
    public partial class Equipment : Resource, IObjectWithChangeTracker, INotifyPropertyChanged
    {
    
        #region Constantes
    
        public new const string TypeFullName = "KProcess.Ksmed.Models.Equipment";
        ...
        /// <summary>
        /// Initialise une nouvelle instance de la classe <see cref="Equipment"/>.
        /// </summary>
    	public Equipment()
    	{
    		this.Initialize();
        ...
        private void FixupProcess(Procedure previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.Equipments.Contains(this))
            {
            ...
            if (Process != null)
            {
                if (!Process.Equipments.Contains(this))
                {
                    Process.Equipments.Add(this);
                }
