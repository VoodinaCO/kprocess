...
namespace KProcess.Ksmed.Models
{
    ...
    /// 
    /// </summary>
    public partial class PublicationLocalization : ModelBase, IObjectWithChangeTracker, INotifyPropertyChanged
    {
    
        #region Constantes
    
        public const string TypeFullName = "KProcess.Ksmed.Models.PublicationLocalization";
        ...
        /// <summary>
        /// Initialise une nouvelle instance de la classe <see cref="PublicationLocalization"/>.
        /// </summary>
    	public PublicationLocalization()
    	{
    		this.Initialize();
    	}
        ...
        private void FixupPublication(Publication previousValue)
        {
            ...
            if (previousValue != null && previousValue.Localizations.Contains(this))
            {
            ...
            if (Publication != null)
            {
                if (!Publication.Localizations.Contains(this))
                {
                    Publication.Localizations.Add(this);
                }
