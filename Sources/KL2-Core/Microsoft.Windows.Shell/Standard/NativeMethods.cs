...
namespace Standard
{
    ...
    internal static class NativeMethods
    {
        ...
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        public static void DwmSetWindowAttributeNcRenderingPolicy(IntPtr hwnd, DWMNCRENDERINGPOLICY value)
        {
            Assert.IsTrue(Utility.IsOSWindows7OrNewer);
            int val = (int)value;
            _DwmSetWindowAttribute(hwnd, DWMWA.NCRENDERING_POLICY, ref val, sizeof(int));
        }
