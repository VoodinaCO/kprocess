...
{
    /// <summary>
    /// Représente un référentiel dans un gantt.
    /// </summary>
    public class ReferentialGanttItem : GanttChartItem, IReferentialItem
    {

        /// <summary>
        /// Initialise une nouvelle instance de la classe <see cref="ReferentialGanttItem"/>.
        /// </summary>
        /// <param name="referential">Le référentiel.</param>
        /// <param name="label">Le libellé du référentiel.</param>
        public ReferentialGanttItem(IActionReferential referential, string label)
        {
