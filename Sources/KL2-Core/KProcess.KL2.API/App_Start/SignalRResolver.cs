...
namespace KProcess.KL2.API.App_Start
{
    public class SignalRResolver : DefaultDependencyResolver
    {
        ...
        public void RegisterHubConnect()
        {
            ...
            container.RegisterType<IKLAnalyzeRepository, KLAnalyzeRepository>(new ContainerControlledLifetimeManager());
            container.RegisterType<KLAnalyzeHub>(new ContainerControlledLifetimeManager(), new InjectionConstructor(container.Resolve<IKLAnalyzeRepository>()));
