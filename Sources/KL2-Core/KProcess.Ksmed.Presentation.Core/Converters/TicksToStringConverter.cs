...
namespace KProcess.Ksmed.Presentation.Core.Converters
{
    ...
    /// </summary>
    public class TicksToStringConverter : MarkupExtension, IValueConverter
    {
        /// <summary>
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return IoC.Resolve<IServiceBus>().Get<ITimeTicksFormatService>().TicksToString(ticks);
        }
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return IoC.Resolve<IServiceBus>().Get<ITimeTicksFormatService>().ParseToTicks((string)value);
        }
    ...
    /// Convertit des ticks en chaîne de caractères.
    /// </summary>
    public class TicksToStringMultiConverter : MarkupExtension, IMultiValueConverter
    {
        /// <summary>
        /// Convertitune la valeur.
        /// </summary>
