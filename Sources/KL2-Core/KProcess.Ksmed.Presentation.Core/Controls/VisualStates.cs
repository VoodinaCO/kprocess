...
namespace KProcess.Ksmed.Presentation.Core.Controls
{
    ...
    internal static class VisualStates
    {
        ...
        public const string SelectionUnselected = "Unselected";
        public const string SelectionSelected = "Selected";
        public const string SelectionSelectedUnfocused = "SelectedUnfocused";
        #endregion
