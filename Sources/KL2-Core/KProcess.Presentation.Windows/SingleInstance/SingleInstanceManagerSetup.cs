...
namespace KProcess.Presentation.Windows.SingleInstance
{
    ...
    public sealed class SingleInstanceManagerSetup
    {
        ...
        /// </summary>
        /// <remarks>
        /// The default value is Exit. When Exit is set,
        ...
        /// <summary>
        /// The exit code to be used if this is not the first application instance, and WindowsRecipes.TaskbarSingleInstance.TerminationOption.Exit
        ...
        /// The default value is WindowsRecipes.TaskbarSingleInstance.InstanceNotificationOption.NotifyAnyway.
        /// </remarks>
        ...
        /// WindowsRecipes.TaskbarSingleInstance.InstanceNotificationOption.NotifyOnlyIfAdmin and this instance doesn't have administrative priviliges.
        /// </remarks>
