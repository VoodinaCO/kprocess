...
namespace KProcess
{
    ...
    /// <summary>
    /// Contains double comparisons helpers
    /// </summary>
    public static class DoubleUtil
    {
        ...
        /// <summary>
        /// Compares two sizes for fuzzy equality.  This function
        /// helps compensate for the fact that double values can 
        /// acquire error when operated upon
        /// </summary>
        /// <param name='size1'>The first size to compare</param>
        /// <param name='size2'>The second size to compare</param>
        /// <returns>Whether or not the two sizes are equal</returns>
        public static bool AreClose(Size size1, Size size2)
        {
            ...
            return (!size1.IsEmpty) &&
                ...
                DoubleUtil.AreClose(size1.Width, size2.Width);
        }
        ...
        /// <summary>
        /// Determines whether the double value is equal to NaN.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>
        ///   <c>true</c> if the double value is equal to NaN.; otherwise, <c>false</c>.
        /// </returns>
        /// <remarks>
        ...
        /// <summary>
        /// Determines whether the specified rectangle has one of it's values which is NaN.
        /// </summary>
        /// <param name="r">The rect.</param>
        /// <returns><c>true</c> if the rect has Nan.</returns>
        public static bool RectHasNaN(Rect r)
        {
