// -----------------------------------------------------------------------
// <copyright file="EventBus.cs" company="Tekigo">
...
namespace KProcess.Presentation.Windows
{
    ...
    public class EventBus : IEventBus
    {
        ...
        /// <summary>
        /// Initialise une nouvelle instance de la classe <see cref="EventBus"/>.
        /// </summary>
        public EventBus()
        {
            IoC.RegisterInstance<IEventBus>(this);
        }
                    ...
                    if (action != null)
                    {
                        ...
                        if (filter == null || ((Predicate<TEvent>)filter)(item))
                        {
                            if (sub.ThreadingStrategy == ThreadingStrategy.Publisher)
                                ...
                                actions.Add(new Action<TEvent>(evt => DispatcherHelper.SafeInvoke(action, evt)));
