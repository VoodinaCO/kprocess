...
namespace System.Windows.Controls.DataVisualization.Charting
{
    ...
    public abstract class DataPointSeriesWithAxes : DataPointSeries, IDataProvider, IRangeProvider, IAxisListener, IValueMarginProvider
    {
        ...
        {
            if (consumer is IAxis axis && ActiveDataPoints.Any())
            {
                ...
                else if (axis == InternalActualDependentAxis)
                {
                    ...
                    var largestAndSmallestValues = DataPointsByActualDependentValue.GetLargestAndSmallestValues();
                    minimumPoint = largestAndSmallestValues.Value.Minimum;
                    maximumPoint = largestAndSmallestValues.Value.Maximum;
