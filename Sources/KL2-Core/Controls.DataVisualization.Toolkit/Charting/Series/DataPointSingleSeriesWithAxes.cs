...
namespace System.Windows.Controls.DataVisualization.Charting
{
    ...
    public abstract class DataPointSingleSeriesWithAxes : DataPointSeriesWithAxes, IRequireGlobalSeriesIndex
    {
        ...
        {
            this.Unloaded += new RoutedEventHandler(DataPointSingleSeriesWithAxes_Unloaded);
        }


        // AJOUT TEKIGO : sans ça, il y a une fuite mémoire

        /// <summary>
        /// Appelé au déchargement de l'élément.
        /// </summary>
        ...
        private void DataPointSingleSeriesWithAxes_Unloaded(object sender, RoutedEventArgs e)
        {
            this.Unloaded -= new RoutedEventHandler(DataPointSingleSeriesWithAxes_Unloaded);
            FreeResources();
        }
