...
{
    static class ScenarioCloneManager
    {
        ...
        /// Le scénario créé
        /// </returns>
        public static async Task<Scenario> CreateDerivatedScenario(KsmedEntities context, Scenario sourceScenario, string natureCode, bool save)
        {
            ...
            return await CreateDerivatedScenario(context, sourceScenario, natureCode, save, targetNumber);
        }
        ...
        /// </returns>
        public static async Task<string[]> EnsureCanShowScenarioInSummary(Scenario scenario, bool updateValue)
        {
