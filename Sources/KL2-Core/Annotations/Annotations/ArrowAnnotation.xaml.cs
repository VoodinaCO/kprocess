...
{
    /// <summary>
    /// Logique d'interaction pour ArrowAnnotation.xaml
    /// </summary>
    public partial class ArrowAnnotation : AnnotationBase, IThicknessEditableAnnotation
    {
        public static readonly DependencyProperty StartXProperty = DependencyProperty.Register("StartX", typeof(double), typeof(ArrowAnnotation), new FrameworkPropertyMetadata(0.0d, UpdateCoordinates));
        public static readonly DependencyProperty StartYProperty = DependencyProperty.Register("StartY", typeof(double), typeof(ArrowAnnotation), new FrameworkPropertyMetadata(0.0d, UpdateCoordinates));
        public static readonly DependencyProperty EndXProperty = DependencyProperty.Register("EndX", typeof(double), typeof(ArrowAnnotation), new FrameworkPropertyMetadata(0.0d, UpdateCoordinates));
        public static readonly DependencyProperty EndYProperty = DependencyProperty.Register("EndY", typeof(double), typeof(ArrowAnnotation), new FrameworkPropertyMetadata(0.0d, UpdateCoordinates));
        public static readonly DependencyProperty ThicknessProperty = DependencyProperty.Register("Thickness", typeof(double), typeof(ArrowAnnotation), new FrameworkPropertyMetadata(3.0, OnThicknessPropertyChanged));
        ...
        {
            var annotation = (ArrowAnnotation)d;
        ...
        {
            ArrowAnnotation obj = (ArrowAnnotation)d;
        ...
        {
            IsInEditModeProperty.OverrideMetadata(typeof(ArrowAnnotation), new FrameworkPropertyMetadata(OnIsInEditModePropertyChanged));
        }
        ...
        public ArrowAnnotation(double startX, double startY, double? endX, double? endY, Brush brush, double? thickness) : this()
        {
        ...
        public ArrowAnnotation(double x, double y, Brush brush) : this()
        {
            X = x;
            Y = y;
            StartX = 0;
