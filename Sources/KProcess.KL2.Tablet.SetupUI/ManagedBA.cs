...
namespace KProcess.KL2.Tablet.SetupUI
{
    public class ManagedBA : BootstrapperApplication, INotifyPropertyChanged
    {
        ...
        protected override void Run()
        {
            ...
            Log("Launching KL² Tablet bootstrapper UX");
            ...
            DetectPackageComplete += (sender, e) =>
            {
                ...
                if (launchAction == LaunchAction.Install && e.PackageId == "KL2FIELDSERVICES_MSI" && e.State == PackageState.Present)
            ...
            DetectRelatedMsiPackage += (sender, e) =>
            {
                ...
                if (launchAction == LaunchAction.Install && e.PackageId == "KL2FIELDSERVICES_MSI" && e.Operation == RelatedOperation.MajorUpgrade)
            ...
            ExecutePackageBegin += (o, e) =>
            {
                switch(e.PackageId)
                {
                    case "KL2FIELDSERVICES_MSI":
                        CurrentlyProcessingPackageName = "KL² Field Services";
                        break;
                    default:
