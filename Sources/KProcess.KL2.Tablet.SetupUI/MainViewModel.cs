...
namespace KProcess.KL2.Tablet.SetupUI
{
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        public const string ApplicationName = "KL2FieldServices";
        ...
        public string Default_KL2InstallPath { get; } = $@"{Environment.GetFolderPath(Environment.SpecialFolder.CommonDocuments)}\{Manufacturer}\{ApplicationName}";
        ...
        public string KL2InstallPath
        {
            ...
            set
            {
                ...
                if (string.IsNullOrEmpty(_KL2SyncPath))
                {
                    _KL2SyncPath = Path.Combine(_KL2InstallPath, "SyncFiles");
                    RaisePropertyChanged(nameof(KL2SyncPath));
                }
            }
        }
        ...
        public string Default_KL2SyncPath { get; } = $@"{Environment.GetFolderPath(Environment.SpecialFolder.CommonDocuments)}\{Manufacturer}\{ApplicationName}\SyncFiles";
        private string _KL2SyncPath = null;
        public string KL2SyncPath
        {
            get { return string.IsNullOrEmpty(_KL2SyncPath) ? Default_KL2SyncPath : _KL2SyncPath; }
            set
            {
                _KL2SyncPath = value;
#if !DEBUG
