...
namespace KProcess.KL2.Tablet.SetupUI
{
    public static class LocalizationExt
    {
        ...
        // Settable string
        private static string _ProductName = "KL²® Field Services";
        ...
        public static Dictionary<string, Dictionary<string, string>> Dictionary = new Dictionary<string, Dictionary<string, string>>()
        {
            { Languages.Français.ToCultureInfoString(), new Dictionary<string, string>(){
                ...
                { "IsRunningMessage", "Pour continuer l'installation, veuillez fermer l'application KL² Tablet."},
                { "Retry", "REESSAYER"},
            ...
            { Languages.English.ToCultureInfoString(), new Dictionary<string, string>(){
                ...
                { "IsRunningMessage", "To continue the installation, please close opened KL² Tablet application."},
                { "Retry", "RETRY"},
                { "Title", "{0} Setup" },
